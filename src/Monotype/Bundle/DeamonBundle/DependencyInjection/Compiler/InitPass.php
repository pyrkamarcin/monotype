<?php
namespace Monotype\Bundle\DeamonBundle\DependencyInjection\Compiler;
...
/**
 * Class InitPass
 * @package Monotype\Bundle\DeamonBundle\DependencyInjection\Compiler
 */
class InitPass implements CompilerPassInterface
{
    ...
    public function process(ContainerBuilder $container)
    {
        ...
        foreach ($config['daemons'] as $name => $cnf) {
            ...
            $cnf['appPidLocation'] =
                rtrim($cnf['appPidDir'], '/') . '/' . $cnf['appName'] . '/' . $cnf['appName'] . '.pid';
